...
class PratoController:
    ...
    def listar():
        ...
        pratos = ListarPratosService.execute(
            id_usuario=session.get('id_estabelecimento'), apenas_favoritos=apenas_favoritos
        )
    ...
    def preparar(id_prato):
        try:
            movimentacao = PrepararPratoService.execute(id_prato, session['id_estabelecimento'])
            return jsonify({
